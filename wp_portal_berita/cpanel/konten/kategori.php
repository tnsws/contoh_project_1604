	...
	if (isset($_GET['aksi']) && $_GET['aksi'] == 'hapus') {
		...
		header('location:'.$_SERVER['PHP_SELF'].'?p=kategori');
	}
			...
			<tr class="<?php echo $style ?>" id="rw_<?php echo $index ?>">
				...
				<td>
					<span class="detail">
						...
						<a href="<?php echo $_SERVER['PHP_SELF'] ?>?p=kategori&amp;aksi=hapus&amp;id=<?php echo $key ?>" class="button" onclick="return confirm('Hapus data?')">Hapus</a>
					</span>
				</td>
			</tr>
		<?php
	...
	<div id="formAdd" title="Kategori">
		<form action="<?php echo $_SERVER['PHP_SELF'] ?>?p=kategori" method="post">
